...
public class ExceptionCustomizada {
    ...
    public static void imprimirArquivoNoConsole(String nomeDoArquivo) {
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "O arquivo " + nomeDoArquivo + " não foi encontrado no diretório ");
    ...
    public static BufferedReader lerArquivos(String nomeDoArquivo) throws ImpossivelAberturaDeArquivoException {
